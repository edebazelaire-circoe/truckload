# Task 16 — Isolation par base entreprise

## Goal

Créer le registre tenant, provisioning, migrations et accès isolé.
...
## Scope
### In Scope
Base centrale minimale + base par entreprise.

### Out of Scope
Déploiement dédié complet.
...
Tests anti-fuite et migrations multi-base.

## Acceptance Criteria

Aucune lecture ou écriture transverse n’est possible.
...
Registre central minimal et base SQLite distincte par entreprise.
