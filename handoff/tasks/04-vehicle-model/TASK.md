# Task 04 — Modèle véhicule versionné

## Goal

Implémenter véhicules, essieux, ouvertures, obstacles, zones et versions.
...
## Scope
### In Scope
Catalogue, customisation, version immuable utilisée par les runs.
...
Tests de versionnement et invariants géométriques.

## Acceptance Criteria

Une optimisation reste liée à la version exacte du véhicule.
...
Catalogue versionné et identifiant `model@version` persisté dans les plans.
