# Task 24 — Performance et observabilité

## Goal

Instrumenter temps, qualité, diagnostics, erreurs et consommation API.
...
## Scope
### In Scope
Métriques, traces, logs structurés, budgets.
...
Tests de charge jusqu’à 100 objets.

## Acceptance Criteria

Le système prouve le respect des budgets et permet d’expliquer les échecs.
...
Temps, statuts, usage, logs défensifs et test 100 objets.
