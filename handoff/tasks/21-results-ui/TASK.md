# Task 21 — Comparaison des résultats

## Goal

Afficher cinq solutions, recommandation, métriques et diagnostics.
...
## Scope
### In Scope
Cartes comparatives, filtre, avantages/inconvénients.
...
Tests d’affichage et états incomplets.

## Acceptance Criteria

La meilleure solution est clairement identifiée et comparable.
...
Cinq cartes, recommandation, métriques, diagnostics et comparaison.
